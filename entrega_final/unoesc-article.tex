...
\begin{itemize}
 \item	Falta de clareza sobre os horários de coleta, especialmente nos dias alternados da coleta seletiva;
 \item	Ausência de informações consolidadas sobre os pontos de entrega voluntária (PEVs);
 \item	Dificuldade de planejamento, principalmente para moradores que saem cedo para trabalhar e não sabem o momento adequado para colocar o lixo na rua;
 \item	Confusão sobre separação correta dos resíduos, que impacta as taxas de reciclagem.
\end{itemize}
...
\begin{itemize}
    ...
    \item	Rotas pré-planejadas e otimizadas, reduzindo consumo de combustível e tempo de operação;
    \item	Navegação guiada por voz, que facilita a adaptação de novos motoristas;
    \item	Atualização em tempo real de rotas, considerando ruas estreitas e restrições de veículos;
    \item	Gestão eficiente de grandes volumes de dados, incluindo milhares de lixeiras e veículos, minimizando erros em processos manuais.Esses sistemas buscam reduzir custos operacionais e impactos ambientais, como ruídos e congestionamentos urbanos .
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|X|X|}
        \hline
        Solução & Pontos Fortes & Limitações \\ \hline
        
        Sensoneo &
        Otimização avançada de rotas; redução de emissões; uso intensivo de tecnologia &
        Voltado à gestão municipal, não ao cidadão. \\ \hline
        
        Monitoramento por GPS (Vitória-ES) &
        Transparência; acompanhamento em tempo real &
        Sem aplicativo para moradores; não informa horários personalizados. \\ \hline
        
        MeuResíduo / DigiResíduos &
        Boa gestão institucional; rastreamento &
        Foco corporativo; ausência de mapas interativos ou gamificação. \\ \hline
        
        Zero Route Planner &
        Planejamento eficiente &
        Não é voltado à coleta urbana doméstica. \\ \hline
    \end{tabularx}
...
\begin{itemize}
 \item	Foco direto no cidadão, não apenas nas prefeituras.
 \item	Centralização total das informações, eliminando a dispersão atual indicada nas entrevistas.
 \item	Sistema de notificações personalizadas, resolvendo a principal dor identificada: a incerteza dos horários da coleta.
 \item	Mapeamento amigável dos PEVs, que falta nos sistemas atuais.
 \item	Gamificação, inexistente nas plataformas analisadas.
 \item	Ferramentas de educação ambiental, melhorando o entendimento sobre separação do lixo.
 \item	Apoio ao planejamento diário do morador, levando em consideração relatos de que muitos saem cedo para trabalhar e não sabem o momento correto de colocar o lixo na rua.
...
\begin{figure}[H]
    \centering
    %\caption{Imagem do projeto montado no tinkercad.}
    \includegraphics[width=1\textwidth]{Figuras/CasosdeUsoEcoleta.jpg}
...
\begin{figure}[H]
    \centering
    %\caption{Imagem do projeto montado no tinkercad.}
    \includegraphics[width=1\textwidth]{Figuras/DiagramaClasses.jpg}
    \caption*{Fonte: Autoria própria.} 
    \label{fig:exemplo}
\end{figure}
...
\begin{figure}[H]
    \centering
    %\caption{Realizar Check-In PEV.}
    \includegraphics[width=1\textwidth]{Figuras/DiagramaComponentes.png}
    \caption*{Fonte: Autoria própria.} 
    \label{fig:exemplo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Realizar Check-In PEV.}
    \includegraphics[width=1\textwidth]{Figuras/DiagramaAtividade.jpg}
    \caption*{Fonte: Autoria própria.} 
    \label{fig:exemplo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Consultar Horários de Coleta.}
    \includegraphics[width=1\textwidth]{Figuras/DiagramaSequencia.jpg}
    \caption*{Fonte: Autoria própria.} 
    \label{fig:exemplo}
\end{figure}
\newpage
\section{Referencias}
\begin{itemize}
   \item SENSONEO. Driver App. Disponível em: https://sensoneo.com/products/driver-app/
   \item SENSONEO. Route Planning. Disponível em: https://sensoneo.com/products/route-planning/
   \item VITÓRIA (ES). Prefeitura Municipal. Monitoramento da coleta de lixo pelo sistema GPS agiliza o serviço na capital. Disponível em:
 https://www.vitoria.es.gov.br/noticias/monitoramento-da-coleta-de-lixo-pelo-sistema-gps-agiliza-o-servico-na-capital-11229
   \item ZERO ROUTE PLANNER. Gestão de resíduos. Disponível em:https://zeorouteplanner.com/pt/gest%C3%A3o-de-res%C3%ADduos/
   \item MEU RESÍDUO. Plataforma de gestão de resíduos. Disponível em:https://www.meuresiduo.com/
   \item DIGIRESÍDUOS. Sistema de gestão de resíduos sólidos. Disponível em:https://www.digiresiduos.com.br/
\end{itemize}
